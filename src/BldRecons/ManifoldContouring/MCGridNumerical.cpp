...
float CMCGrid::pythag_ext(float a, float b)
{
	float absa,absb;
	absa=fabs(a);
	absb=fabs(b);
...
void CMCGrid::svdcmp_ext(float **a, int m, int n, float w[], float **v)
{
...
void CMCGrid::qrdcmp_ext(float **a, int n, float *c, float *d, int *sing)
{
	int i,j,k;
