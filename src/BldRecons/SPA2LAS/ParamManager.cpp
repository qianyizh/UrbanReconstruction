...
void CParamManager::LoadConfiguration()
{
	...
	// m_pInputList
	::GetPrivateProfileStringA( "SPA2LAS", "Input", "stdin", m_pInputFile, 1024, m_pIniName );
	
	// m_pOutputFile
	::GetPrivateProfileStringA( "SPA2LAS", "Output", "stdout", m_pOutputFile, 1024, m_pIniName );

	// m_bClip, m_dbClip
	::GetPrivateProfileStringA( "SPA2LAS", "Clip", "", pString, MAX_STRING, m_pIniName );
	...
	// m_dbSampleRate
	::GetPrivateProfileStringA( "SPA2LAS", "SampleRate", "0.99", pString, MAX_STRING, m_pIniName );
